...
6. Expanding **Applications** lists each application definition — one child node per subfolder of `<artifactsRoot>/Applications/` (see [UC040](../UC400_ApplicationManagement/UC040_DefineApplication.md)/[UC041](../UC400_ApplicationManagement/UC041_BrowseApplicationDefinitions.md)). The **Applications** node itself carries a **New Application** action (inline `+` / context menu), and each application node a **Delete Application** context action — see [UC043](../UC400_ApplicationManagement/UC043_CreateAndDeleteApplicationDefinition.md).
...
2. **Applications** has no children yet (`<artifactsRoot>/Applications/` doesn't exist, or exists but has no subfolders). The extension shows an explanatory placeholder (e.g. "No applications defined yet") rather than an unexplained empty node — see [UC041](../UC400_ApplicationManagement/UC041_BrowseApplicationDefinitions.md). The node's **New Application** action ([UC043](../UC400_ApplicationManagement/UC043_CreateAndDeleteApplicationDefinition.md)) still works in this state.
